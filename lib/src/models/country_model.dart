...
class ListCountryModel {
  ...
  ListCountryModel.fromJson(List<dynamic> parsedJson) {
    List<CountryModel> temp = [];
    for (int i = 0; i < parsedJson.length; i++) {
      CountryModel result = CountryModel.example(parsedJson[i]);
      temp.add(result);
    }
    _results = temp;
  }
  List<CountryModel> get results => _results;
...
class CountryModel {
  ...
  CountryModel.example(json){
    ...
    area= json["area"];
    gini= json["gini"]!= null ? json["gini"].toDouble() : 0.0;
